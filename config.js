...
global.timezone= process.env.TZ || process.env.TIME_ZONE || "North America/Port-au-Prince";
...
global.sudo = process.env.SUDO ? process.env.SUDO.replace(/[\s+]/g, '') : "35416174";
...
global.userImages= process.env.USER_IMAGES || "https://telegra.ph/file/90ff524908adab4558e5d.jpg" // set Image/video urls here
...
module.exports = {
  ...
  packname: process.env.PACK_NAME || "IA FAMOUS-TECH",
  botname : process.env.BOT_NAME  || "IA HABBY88_FFX",
  ownername:process.env.OWNER_NAME|| "HABBY88_FFX",
